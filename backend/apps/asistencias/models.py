...
class AsistenciaClase(TimeStampedModel):
    ...
    def clean(self):
        ...
        # Nota: Se permite registrar asistencia en cualquier momento (antes, durante o después de la clase)
        # Esto permite flexibilidad para casos como:
        # - Registrar ausencias anticipadas
        # - Preparar listas de asistencia
        # - Registrar asistencia el mismo día o después de la clase
