...
from apps.clases.views import (
    ...
    ClaseListCreateView,
    ClaseDetailView,
    InscripcionClaseListCreateView,
    InscripcionClaseDetailView,
)
...
urlpatterns = [
    ...
    path(
        "api/membresias/",
        MembresiaListCreateView.as_view(),
        name="membresia-list-create",
    ),
    path(
        "api/membresias/<int:pk>/",
        MembresiaDetailView.as_view(),
    ...
    path(
        ...
        ConsultarEstadoVigenciaView.as_view(),
        name="membresia-consultar-estado",
    ),
    # Planes de Membresía CRUD
    path(
        "api/planes-membresia/",
        PlanMembresiaListCreateView.as_view(),
        name="plan-membresia-list-create",
    ),
    path(
        "api/planes-membresia/<int:pk>/",
        PlanMembresiaDetailView.as_view(),
        name="plan-membresia-detail",
    ),
    # Promociones CRUD
    path(
        "api/promociones/",
        PromocionListCreateView.as_view(),
        name="promocion-list-create",
    ),
    path(
        "api/promociones/<int:pk>/",
        PromocionDetailView.as_view(),
        name="promocion-detail",
    ),
    # CU19: Gestionar Disciplinas CRUD
    path(
        "api/disciplinas/",
        DisciplinaListCreateView.as_view(),
        name="disciplina-list-create",
    ),
    path(
        "api/disciplinas/<int:pk>/",
    ...
    path(
        ...
        name="inscripcion-clase-list-create",
    ),
    path(
        "api/inscripciones-clase/<int:pk>/",
        InscripcionClaseDetailView.as_view(),
        name="inscripcion-clase-detail",
    ),
