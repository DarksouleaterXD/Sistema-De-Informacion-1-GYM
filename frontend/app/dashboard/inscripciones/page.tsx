                  ...
                  >
                    ...
                    {clases.map((clase) => (
                      <option key={clase.id} value={clase.id}>
                        {clase.disciplina_nombre} - {clase.fecha}{" "}
                        {clase.hora_inicio}
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        <div className="p-6">
          ...
          <p className="text-gray-600 text-center mb-6">
            ...
            <span className="font-semibold">{inscripcion.cliente_nombre}</span>{" "}
            a la clase{" "}
...
function InscripcionesPageContent() {
  ...
  const [selectedInscripcion, setSelectedInscripcion] =
    useState<InscripcionClase | null>(null);
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {inscripciones.map((inscripcion) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <Badge
                            className={getEstadoBadgeColor(inscripcion.estado)}
                          >
