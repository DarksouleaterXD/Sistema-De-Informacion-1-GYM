...
import categoriaService, {
  CategoriaProducto,
  CategoriaProductoListResponse,
} from "@/lib/services/categoria.service";
import CreateEditCategoriaModal from "@/components/categorias/CreateEditCategoriaModal";
...
export default function CategoriasProductoPage() {
  ...
  const [selectedCategoria, setSelectedCategoria] = useState<CategoriaProducto | null>(
    null
  );
  ...
  const fetchCategorias = useCallback(async () => {
    setLoading(true);
    try {
      const response: CategoriaProductoListResponse =
  ...
  }, [currentPage, searchTerm, activoFilter]);
  ...
  const handleDelete = (categoria: CategoriaProducto) => {
    setSelectedCategoria(categoria);
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center h-64 text-gray-500">
                ...
                <p className="text-sm">
                  {searchTerm || activoFilter !== undefined
